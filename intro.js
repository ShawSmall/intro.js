  ...
  function _placeTooltip(targetElement, tooltipLayer, arrowLayer, helperNumberLayer, hintMode) {
    ...
    switch (currentTooltipPosition) {
      ...
      case 'top':
        ...
        break;
      case 'right':
        tooltipLayer.style.left = (targetOffset.width + 30) + 'px';
    ...
    if (oldHelperLayer !== null) {
      ...
      self._lastShowElementTimer = window.setTimeout(function() {
        ...
        if (oldHelperNumberLayer) {
          ...
          if (self._introItems[self._currentStep].numberPosition == 'right') {
            oldHelperNumberLayer.style[self._introItems[self._currentStep].numberPosition] = '-16px';
            oldHelperNumberLayer.style['left'] = 'auto';
          }
          oldHelperNumberLayer.style.visibility = 'visible';
        }
      ...
      skipTooltipButton.onclick = function() {
        ...
        } else if (self._introItems.length - 1 !== self._currentStep && typeof(self._introSkipCallback) === 'function') {
